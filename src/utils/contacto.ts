...
const ORIGENES: Record<string, string> = {
  ...
  '/consultoria/software-gestion/': 'la página de software de gestión',
  '/consultoria/software-gestion/miselup/': 'la página de Miselup',
  '/consultoria/software-gestion/timlup/': 'la página de Timlup',
